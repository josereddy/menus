...
///////////////Rest api timing service
    ...
    public Integer check_reserve_menus(Remote_Put_Reservation_Menus_DTO reservation_put_reservation_menus_dto) {
        ...
        switch(day)
        {
            case "SUNDAY":openhours=menus_mdb.getOpenhours().getSunday();
                break;
            case "MONDAY":openhours=menus_mdb.getOpenhours().getMonday();
                break;
            case "TUESDAY":openhours=menus_mdb.getOpenhours().getTuesday();
                break;
            case "WEDNESDAY":openhours=menus_mdb.getOpenhours().getWednesday();
                break;
            case "THURSDAY":openhours=menus_mdb.getOpenhours().getThursday();
                break;
            case "FRIDAY":openhours=menus_mdb.getOpenhours().getFriday();
                  break;
            case "SATURDAY":openhours=menus_mdb.getOpenhours().getSaturday();
        }
...
//        location = null;
//        location = loc_repo.findByRestaurantcode(code);
//        if (location != null) {
